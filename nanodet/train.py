...
def main(args):
    ...
    # Determine accelerator and devices based on config
    if not cfg.device.gpu_ids:
        # No GPU IDs specified -> use CPU
    ...
    trainer_kwargs = dict(
        ...
        callbacks=[TQDMProgressBar(refresh_rate=0)],  # disable tqdm
        logger=logger,
